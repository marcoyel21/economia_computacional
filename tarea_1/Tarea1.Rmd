...
Debido a que el valor es 1463.597 evidentemente rechazamos la hipótesis nula de que todas las $\beta$ son cero.
...
q <- 0.05
  ...
  # Tenemos únicamente 11 variables que resultan ser significativas con el ajuste 
  #de Holm-Bonferroni
