...
kable(aucs, col.names = c("Modelos","AUC"), booktabs=T, caption="Comparación de modelos")%>%
  kable_styling(position = "center",
                latex_options="HOLD_position")
...
kable(matconf_lasso$table,  booktabs=T, caption = "Lasso")%>%
  kable_styling(position = "center",
                latex_options="HOLD_position")

kable(matconf_tree$table, caption="Tree", booktabs=T)%>%
  kable_styling(position = "center",
                latex_options="HOLD_position")
kable(matconf_rf$table, caption="Random Forest",booktabs=T)%>%
  kable_styling(position = "center",
                latex_options="HOLD_position")
