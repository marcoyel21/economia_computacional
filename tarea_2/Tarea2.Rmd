...
#dataframe
A<-data.frame(data_validation$customer, churn_validation, y_pred_a)
...
tree_score_predict_a <- predict(tree_cut_a,data=data_validation)
tree_class_predict_a <- predict(tree_cut_a,data=data_validation,type="class")

# unir con base de predicciones
A <- cbind(A,tree_score_predict_a,tree_class_predict_a)
...
eval <-bind_cols((churn_validation),
                 pred_rf$predictions)
