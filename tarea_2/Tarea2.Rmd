...
data_training_a <- data_a[training_rows,]
...
```{r}
# corregir
tree_control <- tree.control(nrow(data_training),
             mincut = 1000,
             mindev = 0.05)

tree_estimation <- tree(churn ~ .,
                        data = data_training,
