...
* El valor del telefono, ya que podría servir como un proxy para medir el nivel de ingresos del individuo. Nuevamente, la variable es significativa y de relativa importancia.
...
# 1. SUTVA # En principio cada mensaje y bono va direccionado al celular individual de cada persona, SUTVA solo se violaria si otra persona tiene acceso al celular o a la cuenta de alguien en un grupo de tratamiento.
# 2. Overlap # Forzamos a que cada estrato tuviera 8 grupos, la probabilidad de pertenecer a uno es aproximadamente 1/8 siempre
