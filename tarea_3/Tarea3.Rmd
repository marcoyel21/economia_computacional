...
kable(strats,booktabs=T, align = 'c',col.names = c("Estrato","Tratamiento","n","Probabilidad"),longtable=T)%>%
...
kable(out_misfits_summary,booktabs=T, align = 'c', col.names = c("Estrato","n"))%>%
  kable_styling(position = "center")
kable(m_t,booktabs=T, align = 'c',col.names=c("Tratamiento","n"))%>%
  kable_styling(position = "center")
```
...
# Tablas de balance
# =============================
kable((balance_table(data_4,'treat')), align = 'c',booktabs=T,digits = 2)%>%
