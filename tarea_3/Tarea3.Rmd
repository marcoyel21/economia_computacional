...
data_correctly<-data %>% select(tasa_trans,device_value, phone_verified,age,population,total_purchases,gender_F,months_since_register)
...
El único riesgo sería sería que la asignación fuera desproporcional para los grupos pequeños, (particularmente el 4 y el 8) sin embargo, en promedio se le asignaron 14 personas a cada estrato: 21 para el grupo 4 (4%) y 3 para el 8 (.3%). Sin embargo, como tenemos la claisifiación, podríamos realizar nuestras esitmaciones con y sin misfits.
