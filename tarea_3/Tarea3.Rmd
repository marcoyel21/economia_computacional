...
```{r}
# Vamos a analizar la relacion con un correlograma y con una regresión, sin embargo, debemos hacer un analisis con la base bien codificada.

#categorizó las categoricas
...
# REGRESION
library(stargazer)
modelo_a<-lm(tasa_trans~.-population_type-population-user_id-total_purchases,data) #quito las variables colineales y las objetivo
modelo_b<-lm(total_purchases~.-population_type-population-user_id-tasa_trans,data)#quito las variables colineales y las objetivo
